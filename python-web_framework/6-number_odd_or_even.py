...
"""  a script that starts a Flask web application and display "Hello HBNB!", 
    ...
    display number_template/<n> and  display number_odd_or_even/<n>"""
...
def number_template(n):
    """
    This route displays an HTML page with "Number: n" inside the <H1> tag in the body,
...
def number_odd_or_even(n):
    """
    This route displays an HTML page indicating whether the provided number is even or odd.
